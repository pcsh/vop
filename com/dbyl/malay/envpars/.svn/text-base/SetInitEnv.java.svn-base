...
public class SetInitEnv {
	...
	{
         if(env == 0){          //SIT
        	 driver.get("http://test.zyd.onlyou.com/admin.htm");
        	 return driver;
         }
         else if(env == 1){ //Beta
         //Beta:
        	 driver.get("http://beta.zyd.onlyou.com/admin.htm");
        	 return driver;
         }
         else if(env == 2){ 
             //maly:
	...
	public WebDriver envchoicePartner(int env,WebDriver driver)
	{
		if(env == 0){          //SIT
            ...
            //Beta:
            driver.get("http://beta.zyd.onlyou.com/login.htm");
            return driver;
            }
        else if(env == 2){//maly
        	driver.get("http://172.16.6.172:8081/");
	...
	public Map<String, String> envParameters()
	{
        ...
        Map<String, String> result = new HashMap<String, String>();
         ...
         //result.put("strLoginqP", strLoginq);
